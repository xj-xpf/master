...
{     
    ...
    $vaules = array(            
     ...
     $url = "http://service.xx.com/index.php?m=Home&c=Index&a=user_push&".http_build_query($vaules);
...
//					array('name'=>'APP设置','act'=>'appSet','control'=>'System'),
...
//					array('name' => '供应商管理', 'act'=>'supplier', 'control'=>'Admin'),
			...
			'member' => array('name'=>'会员管理','icon'=>'fa-user','sub_menu'=>array(
                    ...
                    array('name'=>'获奖记录','act'=>'awardList','control'=>'User'),
                    array('name'=>'赚钱记录','act'=>'adMoneyList','control'=>'User'),
                    array('name'=>'收获地址列表','act'=>'addressList','control'=>'User'),
...
//					array('name' => '快递单', 'act'=>'express_list', 'control'=>'Order'),
			...
			'promotion' => array('name' => '促销管理', 'icon'=>'fa-bell', 'sub_menu' => array(
                    ...
                    array('name' => '品牌清仓', 'act'=>'prom_goods_list', 'control'=>'Promotion'),
