...
class ReportController extends BaseController{
	...
	public function saleTop(){
		$sql = "select order_goods.goods_name,order_goods.goods_sn,sum(order_goods.goods_num) as sale_num,sum(order_goods.goods_num*order_goods.goods_price) as sale_amount from __PREFIX__order_goods order_goods";
		$sql .=" left join __PREFIX__order orders on orders.order_id = order_goods.order_id";
		$sql .=" where order_goods.is_send = 1 and orders.pay_time>$this->begin and orders.pay_time<$this->end group by order_goods.goods_id order by sale_amount DESC limit 100";
