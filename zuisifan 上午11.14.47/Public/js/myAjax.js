...
function changeTableVal(table,id_name,id_value,field,obj)
{
        ...
        if( field == 'is_show' && value == 1 && table == 'goods_category'){
            $.ajax({
                url:"/index.php?m=Admin&c=Index&a=search_show_category&table="+table+"&id_name="+id_name+"&id_value="+id_value+"&field="+field+'&value='+value,
